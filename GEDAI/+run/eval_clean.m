...
gedai.evalplots.psd_per_stage(PwrClean, PwrRaw, FreqsClean, FreqsRaw, stageScoring, FzIdx, ...
    'FreqLim', opts.FreqLim, 'FreqScale', opts.FreqScale, 'SavePath', opts.SavePath);

gedai.evalplots.psd_overview(PwrClean, PwrRaw, FreqsClean, FreqsRaw, stageScoring, FzIdx, ...
    'FreqLim', opts.FreqLim, 'FreqScale', opts.FreqScale, 'SavePath', opts.SavePath);

gedai.evalplots.topo_band_power(PwrClean, PwrRaw, FreqsClean, FreqsRaw, stageScoring, ...
    EEGraw.chanlocs, 'CLims', opts.TopoBandLims, 'SavePath', opts.SavePath);

gedai.evalplots.topo_band_stage(PwrClean, PwrRaw, FreqsClean, FreqsRaw, stageScoring, ...
...
gedai.evalplots.timefreq(PwrClean, PwrRaw, FreqsClean, FreqsRaw, stageScoring, FzIdx, ...
