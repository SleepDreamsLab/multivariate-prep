...
[PwrClean, Freqs] = qol.smartcache( ...
    @() wrapper.run_pwelch(EEGclean, opts.EpochLength, ...
...
[PwrRaw, Freqs] = qol.smartcache( ...
    @() wrapper.run_pwelch(EEGraw, opts.EpochLength, ...
        opts.WelchWindow, opts.WelchOverlap), ...
            fullfile([opts.SavePath '_' 'PSDraw' '.mat']), ...
            opts.refresh , {'Power', 'Freqs'});

% [PwrClean, Freqs] = wrapper.run_pwelch(EEGclean, opts.EpochLength, ...
%     opts.WelchWindow, opts.WelchOverlap);
% 
% [PwrRaw, ~] = wrapper.run_pwelch(EEGraw, opts.EpochLength, ...
%     opts.WelchWindow, opts.WelchOverlap);
...
for iRange = 1:numel(fooofRanges)
    ...
    [FooofRaw] = qol.smartcache( ...
        @() wrapper.run_fooof(powerRawSmooth, Freqs, [], ...
            'FrequencyRange', fr, ...
    ...
    [FooofClean] = qol.smartcache( ...
        @() wrapper.run_fooof(powerCleanSmooth, Freqs, [], ...
            'FrequencyRange', fr, ...
            'MeanSmoothSpan', opts.FooofMeanSmooth, ...
            'MedianSmoothSpan', opts.FooofMedianSmooth, ...
            'PeakWidthLimits', opts.FooofPeakWidthLims, ...
...
%     FooofClean = wrapper.run_fooof(pwr, Freqs, [], ...
%         'FrequencyRange', fr, ...
%         'MeanSmoothSpan', opts.FooofMeanSmooth, ...
%         'MedianSmoothSpan', opts.FooofMedianSmooth, ...
%         'PeakWidthLimits', opts.FooofPeakWidthLims, ...
