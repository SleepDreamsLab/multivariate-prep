...
% %%% Step #3.2 -> Ground-truth benchmark of GEDAI (optional; see Benchmark/DESIGN.md)
% %%% Injects graphoelements and EOG/EMG/ECG into selected epochs of the GEDAI input and
% %%% scores over- and under-cleaning. Not needed for preprocessing; run on a few recordings.
% fails.benchmark = bidsfun_gedai_benchmark(BIDS, defaults{:}, ...
%     'inputdesc', filtdesc, ...
%     'desc', [geddesc 'bench'], ...
%     'leadfielddir', leadfieldpath, ...
%     'scoringpath', scoringpath, ...
%     'runs', gedai.defaultRuns(), ...
%     'nepochs', 40);
